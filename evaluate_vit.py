...
def plot_confusion_matrix(cm, classes, save_path):
    ...
    ax.set_title("Confusion Matrix - ViT-Tiny Baseline")
...
def plot_roc_curve(y_true, y_prob, save_path):
    ...
    plt.title("ROC Curve - ViT-Tiny Baseline")
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="checkpoints/vit_tiny_cifake_best.pth")
    ...
    print("=" * 80)
    print("Evaluating ViT-Tiny Baseline")
    print("=" * 80)
    ...
    model = ViTBaseline(num_classes=2, pretrained=False).to(device)
    ...
    save_metrics_csv(
        Path("results/tables/vit_tiny_cifake_metrics.csv"),
        metrics,
    )
    ...
    plot_confusion_matrix(
        cm,
        classes,
        Path("results/figures/vit_tiny_confusion_matrix.png"),
    )

    plot_roc_curve(
        y_true,
        y_prob,
        Path("results/figures/vit_tiny_roc_curve.png"),
    )
    ...
    print("\nSaved:")
    print("results/tables/vit_tiny_cifake_metrics.csv")
    print("results/figures/vit_tiny_confusion_matrix.png")
    print("results/figures/vit_tiny_roc_curve.png")
