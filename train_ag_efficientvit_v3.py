...
def main():
    ...
    print("=" * 80)
    print("AG-EfficientViT Project | Proposed Model: AG-EfficientViT V3 Fine-Tuned Branch Fusion")
    print("=" * 80)
    ...
    log_path = log_dir / "ag_efficientvit_v3_cifake_log.csv"

    if log_path.exists():
        log_path.unlink()

    best_f1 = -1.0
    best_path = checkpoint_dir / "ag_efficientvit_v3_cifake_best.pth"
