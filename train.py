...
def main():
    ...
    print("=" * 80)
    print("AG-EfficientViT Project | Baseline: EfficientNetB0")
    print("=" * 80)
    ...
    model = EfficientNetB0Baseline(num_classes=2, pretrained=True).to(device)
    ...
    log_path = log_dir / "efficientnet_b0_cifake_log.csv"

    if log_path.exists():
        log_path.unlink()

    best_f1 = -1.0
    best_path = checkpoint_dir / "efficientnet_b0_cifake_best.pth"
