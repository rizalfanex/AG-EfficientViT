...
def main():
    ...
    print("=" * 80)
    print("AG-EfficientViT Project | Proposed Model: AG-EfficientViT V2")
    print("=" * 80)
    ...
    model = AGEfficientViTV2(num_classes=2, pretrained=True).to(device)
    ...
    log_path = log_dir / "ag_efficientvit_v2_cifake_log.csv"

    if log_path.exists():
        log_path.unlink()

    best_f1 = -1.0
    best_path = checkpoint_dir / "ag_efficientvit_v2_cifake_best.pth"
