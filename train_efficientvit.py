...
def main():
    ...
    print("=" * 80)
    print("AG-EfficientViT Project | Baseline: EfficientViT Hybrid")
    print("=" * 80)
    ...
    model = EfficientViTBaseline(num_classes=2, pretrained=True).to(device)
    ...
    log_path = log_dir / "efficientvit_baseline_cifake_log.csv"

    if log_path.exists():
        log_path.unlink()

    best_f1 = -1.0
    best_path = checkpoint_dir / "efficientvit_baseline_cifake_best.pth"
