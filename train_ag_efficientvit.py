...
def main():
    ...
    print("=" * 80)
    print("AG-EfficientViT Project | Proposed Model: Artifact Guided EfficientViT")
    print("=" * 80)
    ...
    model = AGEfficientViT(num_classes=2, pretrained=True).to(device)
    ...
    log_path = log_dir / "ag_efficientvit_cifake_log.csv"

    if log_path.exists():
        log_path.unlink()

    best_f1 = -1.0
    best_path = checkpoint_dir / "ag_efficientvit_cifake_best.pth"
